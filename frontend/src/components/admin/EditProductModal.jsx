...
// // --- Constants for Dropdowns from Schema Enums ---
...
//   // Initialize form state with a deep copy of the product prop
//   useEffect(() => {
//     if (product) {
...
//                         </div>
//                       </div>
//                       {/* --- NEW: Color Images with Previews --- */}
//                       <div>
//                         <Label>Images</Label>
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[950px] max-h-[90vh] overflow-y-auto">
        ...
        <div className="py-4 space-y-6">
          ...
          {/* --- UPDATED: Added Display Settings Section --- */}
          <div className="p-4 border rounded-lg space-y-4">
