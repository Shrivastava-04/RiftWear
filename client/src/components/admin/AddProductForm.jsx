...
// //       Hoodie: false,
// //     },
// //     colors: [], // NEW: Changed to an array of objects
// //     forDepartment: false,
// //     departmentName: "",
// //     sizeChart: [],
// //     category: "",
...
// //   // Generic handler for regular inputs
// //   const handleChange = (e) => {
// //     const { name, value, type, checked } = e.target;
// //     setFormData((prevData) => ({
// //       ...prevData,
...
// //   // Handles checkbox changes for sizes and varieties
// //   const handleCheckboxChange = (field, key, checked) => {
// //     setFormData((prevData) => ({
// //       ...prevData,
// //       [field]: {
...
// //   // Handles adding/removing/changing features
// //   const handleFeatureChange = (index, value) => {
// //     setFormData((prevData) => {
// //       const newFeatures = [...prevData.features];
// //       newFeatures[index] = value;
...
// //       uploadedUrls: [], // Reset uploaded URLs for a new upload
// //     };
// //     setFormData({ ...formData, colors: newColors });
// //   };
...
//       Hoodie: false,
//     },
//     colors: [], // Correctly initialized as an array
//     forDepartment: false,
//     departmentName: "",
//     sizeChart: [],
//     category: "",
...
//   // --- UPDATED: Color Variant Handlers ---
//   const handleColorChange = (index, value) => {
//     const newColors = [...formData.colors];
//     if (!newColors[index]) {
//       newColors[index] = { name: "", selectedFiles: [], uploadedUrls: [] };
//     }
...
//       newColors[colorIndex] = { name: "", selectedFiles: [], uploadedUrls: [] };
//     }
//     newColors[colorIndex].selectedFiles = Array.from(files);
//     newColors[colorIndex].uploadedUrls = []; // Reset uploaded URLs for a new upload
//     setFormData({ ...formData, colors: newColors });
//   };
